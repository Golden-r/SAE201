## Réseaux urbains
8+ ANS — 30–60 MINUTES — 2–5 JOUEURS
...
2. Chaque joueur choisit une couleur et prend ses marqueurs (bases et éventuellement pions distinctifs).  
3. Placez sur le plateau les bâtiments selon la mise en place convenue (ou laissez libre).  
4. Positionnez au moins une base par couleur sur le plateau. Plusieurs bases d’une même couleur peuvent partager un quartier.  
5. Mélangez les cartes et placez la pioche ; laissez visible le mode de pioche (face visible ou face cachée).  
6. Déterminez l’ordre des manches : une manche par couleur.
...
1. Annoncez la couleur de la manche (ex. « Manche Eau »).  
...
1. Pour chaque quartier, identifiez la plus grande chaîne de bâtiments correspondant à la couleur de la manche.  
2. Le quartier qui possède la plus grande chaîne rapporte : taille de la chaîne × poids du quartier (poids par défaut = 1).  
3. Variante (choisir avant la partie) :  
   - Variante A (par joueur) : chaque joueur compte ses propres bâtiments reliés pour obtenir ses points.  
   - Variante B (contrôle de quartier) : les points du quartier vont au joueur qui contrôle la plus grande chaîne.  
4. Notez les points sur la piste de score.
...
- Piocher une carte (et jouer si possible)  
- Jouer une carte pour placer/relier un bâtiment  
